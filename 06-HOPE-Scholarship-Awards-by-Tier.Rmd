...
dt_hope_bar_amt <- setDT(readRDS(here::here("/rds", "dt_hope_bar_amt.rds")))
# ------------------------------------------------------------------------------
```
...
knitr::include_graphics(here::here('png/p6a1.png'))
```

## 06. HOPE Scholarship Awards by Tier
```{r 6.2, fig.cap='Awd by Tier'}
knitr::include_graphics(here::here('png/p6a2.png'))
```

## 06. Percent Change in HOPE Scholarship Awards by Tier
```{r 6.3, fig.cap='Pct. Change by Tier'}
knitr::include_graphics(here::here('png/p6a3.png'))
```
