...
## 04. Financial Aid Awarded: Sources of Financial Aid
```{r 4.1.0-aid-source, echo=FALSE, fig.cap='Sources of Financial Aid', message=FALSE, warning=FALSE}
...
## 04. Financial Aid Awarded: Types of Financial Aid
```{r 4.2.0-aid-type, echo=FALSE, fig.cap='Types of Financial Aid', message=FALSE, warning=FALSE}
